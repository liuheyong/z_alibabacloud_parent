...
@EnableBinding(ZCloud3StreamExceptionHandler2Application.TestTopic.class)
@SpringBootApplication
public class ZCloud3StreamExceptionHandler2Application {

    public static void main(String[] args) {
        SpringApplication.run(ZCloud3StreamExceptionHandler2Application.class, args);
    }
