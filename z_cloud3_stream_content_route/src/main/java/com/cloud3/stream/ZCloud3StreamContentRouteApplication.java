...
@EnableBinding(ZCloud3StreamContentRouteApplication.TestTopic.class)
@SpringBootApplication
public class ZCloud3StreamContentRouteApplication {

    public static void main(String[] args) {
        SpringApplication.run(ZCloud3StreamContentRouteApplication.class, args);
    }
