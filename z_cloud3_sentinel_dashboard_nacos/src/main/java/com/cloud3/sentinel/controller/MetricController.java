...
import com.cloud3.sentinel.domain.vo.MetricVo;
import com.cloud3.sentinel.repository.metric.MetricsRepository;
...
public class MetricController {
    ...
    public Result<?> queryByAppAndResource(String app, String identity, Long startTime, Long endTime) {
        ...
        List<MetricVo> vos = (List<MetricVo>) MetricVo.fromMetricEntities(entities, identity);
