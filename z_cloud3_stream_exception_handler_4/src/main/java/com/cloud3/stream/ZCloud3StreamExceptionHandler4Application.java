...
@EnableBinding(ZCloud3StreamExceptionHandler4Application.TestTopic.class)
@SpringBootApplication
public class ZCloud3StreamExceptionHandler4Application {

    public static void main(String[] args) {
        SpringApplication.run(ZCloud3StreamExceptionHandler4Application.class, args);
    }
